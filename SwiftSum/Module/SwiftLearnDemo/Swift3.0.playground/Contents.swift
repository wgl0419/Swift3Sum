...
/*
 ...
 Swift 3 里保留的 Swift 语法和 API 让语言更感自然，并且在调用 Cocoa 框架时提供了更加 Swift-y[1] 的体验。流行的框架 Core Graphics 和 Grand Central Dispatch 现在在 Swift 中有了一个全新、更加清晰的接口。这次发布同时提升了编译性能
